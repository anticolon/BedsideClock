 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --bpp 4 --size 64 --no-compress --stride 1 --align 1 --font Montserrat-Bold.ttf --range 48-58 --format lvgl -o lv_font_clock_big.c
 ******************************************************************************/
...
#ifndef LV_FONT_CLOCK_BIG
#define LV_FONT_CLOCK_BIG 1
#endif

#if LV_FONT_CLOCK_BIG
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 917, .adv_w = 401, .box_w = 20, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1367, .adv_w = 604, .box_w = 36, .box_h = 46, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2195, .adv_w = 606, .box_w = 37, .box_h = 46, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 3046, .adv_w = 706, .box_w = 43, .box_h = 45, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4014, .adv_w = 609, .box_w = 37, .box_h = 46, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4865, .adv_w = 652, .box_w = 38, .box_h = 47, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 5758, .adv_w = 635, .box_w = 37, .box_h = 45, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 6591, .adv_w = 676, .box_w = 38, .box_h = 47, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 7484, .adv_w = 652, .box_w = 38, .box_h = 47, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 8377, .adv_w = 268, .box_w = 13, .box_h = 37, .ofs_x = 2, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_clock_big = {
#else
lv_font_t lv_font_clock_big = {
#endif
